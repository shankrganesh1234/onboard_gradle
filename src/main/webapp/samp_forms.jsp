    ...
    <div id="popup<%=i %>" class="overlay">
        <div class="popup">
            ...
            <div class="ScrollStyle">
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-lg-8">
                            ...
                            <select id="types<%=i %>" class="form-control" name="types<%=i %>"
                                    onChange="call('<%=i %>')" required>
                ...
                <div class="row" id="rdo<%=i %>" style="display:none;">
                    <div class="form-group">
                        <div class="col-sm-4">
                            ...
                            <input type="text" class="form-control" id="radio_number<%=i %>" name="radio_number<%=i %>"
                                   onChange="radio('<%=i %>')">
                        </div>
                    </div>
                    <br/>
                ...
                <div class="row" id="drop<%=i %>" style="display:none;">
                    <div class="form-group">
                        <div class="col-sm-4">
                            ...
                            <input type="text" class="form-control" id="drop_number<%=i %>" name="drop_number<%=i %>"
                                   onChange="drp_dwn('<%=i %>')">
                        </div>
                    </div>
                    <br/>
                ...
                <button type="button" onclick="window.location.href='samp_business.jsp'" class="btn btn-default">
                    Cancel
                </button>
            </div>
        </div>
