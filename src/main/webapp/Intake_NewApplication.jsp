                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title"><a class="collapsed" data-toggle="collapse"
                                                                           ...
                                                                           onclick="switchColors0();">Application
                                                    Information</a></h4>
                                            </div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group row log-date">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input placeholder="mm/dd/yyyy" id="rod" name="rod"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="formInput229"
                                                               placeholder="DB Size" name="dbsize">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label" for="formInput229">Location of DB
                                                        </label>
                                                        <input type="text" class="form-control" id="formInput229"
                                                               placeholder="Location of DB" name="dbloc">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label" for="formInput229">Legacy
                                                            Application SME
                                                        </label>
                                                        <input type="text" class="form-control" id="formInput229"
                                            ...
                                            <div id="collapse2" class="panel-collapse collapse ">
                                                <div class="panel-body text-left">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="formInput253"
                                                               placeholder="Details" name="users">
                                                    </div>
