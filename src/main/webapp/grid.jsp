...
<div></i><span><hr class="hr-primary"/>
    </i></span></div>
<div><i class="fa fa-arrow-down" style="font-size:24px;color:rgba(66,133,244,.8); margin:-25px 6px"><i
        class="fa fa-arrow-down" style="font-size:24px;color:rgba(66,133,244,.8); margin:-10px 378px"></i></i></div>
<span>
                                ...
                                <div class="col-md-2 col-sm-2">
                                    ...
                                    <a href="AppEmphasize_EditProject.jsp">
                                        <center>
                                            <img src="images/grid/app.png" class="img-rounded" height="100" width="100"
                                                 alt="Avatar">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    ...
                                    <a href="Applications.jsp">
                                        <center>
                                            <img src="images/grid/intake.png" class="img-rounded" height="100"
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <a href="Archive_Execution.jsp">
                                        <center>
                                            <img src="images/grid/archival-execution.png" class="img-rounded"
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <a href="#">
                                        <center>
                                            <img src="images/grid/decommission-execution.png" class="img-rounded"
                                                 height="100" width="100" alt="Avatar">
                            ...
                            <div class="col-md-12" id="box1">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <a href="Admin_UserConfiguration.jsp">
                                        <center>
                                            <img src="images/grid/admin.png" class="img-rounded" height="100"
                                                 width="100" alt="Avatar">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <a href="RoleUIDashboard.jsp">
                                        <center>
                                            <img src="images/grid/reporting.png" class="img-rounded" height="100"
                                                 width="100" alt="Avatar">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <a href="#">
                                        <center>
                                            <img src="images/grid/program-governance.png" class="img-rounded"
                                                 height="100" width="100" alt="Avatar">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <a href="#">
                                        <center>
                                            <img src="images/grid/finance.png" class="img-rounded" height="100"
                                                 width="100" alt="Avatar">
...
<span>
                                    ...
                                    <div class="col-md-2 col-sm-2">
                                        <a href="AppEmphasize_EditProject.jsp">
                                            <center>
                                                <img src="images/grid/app.png" class="img-rounded" height="100"
                                                     width="100" alt="Avatar">
                                                <h6 class="mt-5">App Emphasize</h6>
                                            </center>
                                        </a>
