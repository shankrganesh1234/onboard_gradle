                    ...
                    <div class="sidebar-content" id='jqxWidget'>
                        ...
                        <div class="sidebar-nav">
                            <ul class="side-nav color-gray">
                                ...
                                <li>
                                    <a href="Registration.jsp"><i class="fa fa-file-text"></i>
                                        <span>User Configuration</span> </a>
                                </li>

                                <li>
                                    <a href="userslist.jsp"><i class="fa fa-paint-brush"></i> <span>Users List</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="roledetails.jsp"><i class="fa fa-map-signs"></i>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="content table-full-width table-responsive">
                                                        <table class="table table-hover table-striped">
                                                            ...
                                                            %>
                                                            <tr>
                                                                <td><input class="act" style="width:200px;" type="text"
                                                                           name="role<%=i %>"
                                                                           value="<%= rs.getString(1) %>"></td>
                                                                <td><input class="act" type="text" name="admin<%=i %>"
                                                                           value="<%= rs.getString(2) %>"></td>
                                                                <td><input class="act" type="text" name="app_emp<%=i %>"
                                                                           value="<%= rs.getString(3) %>"></td>
                                                                <td><input class="act" type="text" name="intake<%=i %>"
                                                                           value="<%= rs.getString(4) %>"></td>
                                                                <td><input class="act" type="text"
                                                                           name="arch_exe<%=i %>"
                                                                           value="<%= rs.getString(5) %>"></td>
                                                                <td><input class="act" type="text" name="decomm<%=i %>"
                                                                           value="<%= rs.getString(6) %>"></td>
                                                                <td><input class="act" type="text"
                                                                           name="prgm_gov<%=i %>"
                                                                           value="<%= rs.getString(7) %>"></td>
                                                                <td><input class="act" type="text" name="report<%=i %>"
                                                                           value="<%= rs.getString(8) %>"></td>
                                                                <td><input class="act" type="text" name="finance<%=i %>"
