        ...
        <div class="content-wrapper">
            <div class="content-container">
                ...
                style = "color:white" > 1 < /a>
                    ...
                    < div
                class
                = "col-xs-3 bs-wizard-step complete" > <!-- complete -->
                    < div
                class
                = "text-center bs-wizard-stepnum" > Cost
                Complexity
                Calculation < /div>
                < div
                class
                ...
                = "bs-wizard-info text-center" > < /div>
                    ...
                    < div
                class
                = "col-xs-3 bs-wizard-step complete" > <!-- active -->
                    < div
                class
                ...
                = "bs-wizard-info text-center" > < /div>
                    ...
                    < tr > < a
                href = "AppEmphasize_PrioritizedApplications.jsp"
                class
                = "btn btn-success"
                class
                = "btn pull-right" > < span
                class
                = "glyphicon glyphicon-download-edit" > < /span>Back</
                a >
                < button
                id = "exportview"
                class
                ...
                class
                = "glyphicon glyphicon-download-alt" > < /span> Export PDF</
                button > < /tr></
                br > < br >
                < div
                class
