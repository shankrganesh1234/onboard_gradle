                                        ...
                                        <form role="form">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" for="formInput198">
                                                    <div class="required_fie"> Project Name&nbsp;<span
                                                            class="text-danger"></span></div>
                                                </label>
                                                <input type="text" class="form-control" id="formInput198"
                                                       placeholder="Project Name" name="projectname" required/>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" for="formInput229">
                                                    <div class="required_fie">Description&nbsp;<span
                                                            class="text-danger"></span></div>
                                                </label>
                                            ...
                                            <div class="form-group row log-date">
                                                <div class="col-md-12">
                                                    ...
                                                    <input placeholder="No of Applications" id="date" name="appno"
                                            ...
                                            <div class="form-group row log-date">
                                                <div class="col-md-12" id="basicExample">
                                                    <label class="control-label">
                                                        <div class="required_fie">Initiate Start Date&nbsp;<span
                                                                class="text-danger"></span></div>
                                                    </label>
                                            ...
                                            <div class="form-group row log-date">
                                                <div class="col-md-12" id="basicExample">
                                                    ...
                                                    <input placeholder="mm/dd/yyyy" id="P_S_date" name="Plandate"
                                                           class="form-control ember-text-field zf-date-picker date-picker ember-view date start"
                                                           type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row log-date">
                                                <div class="col-md-12" id="basicExample">
                                                    ...
                                                    <input placeholder="mm/dd/yyyy" id="Exec_start_date" name="Execdate"
                                                           class="form-control ember-text-field zf-date-picker date-picker ember-view date start"
                                                           type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row log-date">
                                                <div class="col-md-12" id="basicExample">
                                                    ...
                                                    <input placeholder="mm/dd/yyyy" id="Hyper_care_date"
                                                           name="Hyperdate"
                                                           class="form-control ember-text-field zf-date-picker date-picker ember-view date start"
                                                           type="text">
                                                </div>
                                            ...
                                            <div class="form-group row log-date">
                                                <div class="col-md-12" id="basicExample">
                                                    <label class="control-label required">
                                                        <div class="required_fie">Project End Date&nbsp;<span
                                                                class="text-danger"></span></div>
                                                    </label>
                                                    <input placeholder="mm/dd/yyyy" id="Project_end_date" name="Enddate"
                                                           class="form-control ember-text-field zf-date-picker date-picker ember-view date start"
                                                           type="text" required>
                                                </div>
                                            </div>
                                            ...
                                            <br/>
                                            <button type="button" class="btn btn-primary btn pull-left"
                                                    onclick="valid1()">Save
                                            </button>&nbsp;
                                            <button type="button" class="btn btn-default"
                                                    onclick="location.href='Project_List.jsp';">Back
                                            </button>
