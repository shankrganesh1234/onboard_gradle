                    ...
                    <div class="sidebar-nav">
                        <ul class="side-nav color-gray">
                            ...
                            <li class="has-children">
                                ...
                                <ul class="child-nav">
                                    <li><a href="Intake_TechnicalDetails.jsp"> <span>Application Data Information</span></a>
                                    </li>
                                    <li><a href="Intake_TechnicalDetails.jsp"> <span>Infrastructure & Environment Inforamation</span></a>
                                    </li>
                                    <li><a href="Intake_TechnicalDetails.jsp"> <span>Technical Information</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="has-children">
                    ...
                    <div class="content-container">
                        ...
                        <div class="main-page">
                            ...
                            <div class="container"><br/><br/>
                                ...
                                <br/>
                                <input type="text" id="servlet_name" name="servlet_name" value="<%= name %>"
                                       style="display:none;">
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-sm-8">
                                            <label class="control-label" for="formInput526">Type:</label>
                                            <select id="types" class="form-control" name="types" onChange="call()"
                                                    required>
                                ...
                                <div class="row" id="check" style="display:none;">
                                    <div class="form-group">
                                        <div class="col-sm-8">
                                            <label class="control-label" for="formInput526">Number of check
                                                boxes:</label>
                                ...
                                <div class="row" id="rdo" style="display:none;">
                                    <div class="form-group">
                                        <div class="col-sm-8">
                                            <label class="control-label" for="formInput526">Number of Radio
                                                boxes:</label>
                                            <input type="text" class="form-control" id="radio_number"
                                                   name="radio_number" onChange="radio()">
                                        </div>
                                    </div>
                                    <br/>
                                </div>
                                ...
                                <button type="button" onclick="window.location.href='Intake_Business.jsp'"
