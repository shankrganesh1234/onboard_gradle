                        ...
                        <ul class="side-nav color-gray">
                            ...
                            <li class="has-children">
                                ...
                                <ul class="child-nav">
                                    ...
                                    <li><a href="ProjectManager_dashboard.jsp" class="active-menu"> <span>Project Manager Dashboard</span></a>
                                    </li>
                            ...
                            <div class="col-lg-7 col-md-7">
                                    ...
                                    <div class="card-body">
                                        <div class="row" id="rowdate">
                                            ...
                                            <div class="col-lg-4 col-md-12">
                                                <div class="btn-group">
                                                    <button id="column" class="btn btn-default btn-sm"
                                                            onclick="myColumnchart()">
                                                        <span class="fa fa-bar-chart fa-2x"></span>
                                                    </button>
                                                    <button href="#" id="grid" class="btn btn-default btn-sm"
                                                            onclick="myTablechart()">
                                            ...
                                            <div class="row" id="rowbarchart">
                                                <div class="col-lg-12 col-md-12">
                                                    ...
                                                    <div class="col-lg-2 col-md-2" id="fromdate">
                                                        <p><input type="text" data-provide="datepicker"
                                                                  class="form-control" id="fromDate"
                                                                  placeholder="Select date"></p>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2 col-md-2">
                                                        <p><input type="text" data-provide="datepicker"
                                                                  ...
                                                                  onchange="getDateValue(this.id,'fromDate')"
                                                                  placeholder="Select date"></p>
                                                    </div>
                                                    <div class="col-lg-2 col-md-2">
                             ...
                             <span>
                                  <select class="form-control" id="projectvaluepie"
                                          onChange="application_bar(this.value,'barchart')"></select>
                             </span>
                                                    </div>
                                                </div>
                                                <br><br>
                                                <div id="tooltip_action"
                                                     style="width:750px;padding:20px ;height:350px;"></div>
                                            </div>
                                        </div>  <!-- bar chart -->
                                        <!-- end of barchart row -->
                                        <!-- start of table row -->
                                        ...
                                        <!-- bar chart -->
                                        <div class="container-fluid" id="rowtable" hidden>
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="col-lg-12 col-md-12" id="content">
                                                <div class="col-lg-4 col-md-4">
                                                    <p><input type="text" data-provide="datepicker" class="form-control"
                                                              id="fromDatepie" placeholder="Select from date"></p>
                                                </div>

                                                <div class="col-lg-4 col-md-4">
                                                    <p><input type="text" data-provide="datepicker" class="form-control"
                                                              id="toDatepie"
                                                              onchange="getDateValuepie(this.id,'fromDatepie')"
                                                              placeholder="Select to date"></p>
                                                </div>

                                                <div class="col-lg-4 col-md-4" id="project_list1">
          <span>
		          <select class="form-control" id="projectvaluepiechart"
                          onChange="application_bar(this.value,'piechart')">
						      </select> 
</span>
                                                </div>
