...
//System.out.println(rs9.getString("projectname"));
                                    ...
                                    <input type="text" id="project_name" name="project_name"
                                           value="<%=rs.getString("projectname")%>" style="display:none;">
                                    <%
...
//System.out.println(plan);
                                    ...
                                    <a href="archive_exec_samp.jsp" class="btn btn-primary"
                                       class="btn pull-right">Edit</a>
                                    <button id="pdf-button" type="button" class="btn btn-primary" value="Download PDF"
                                            onclick="downloadPDF()"/>
                                    Export PDF</button>
	...
	<span style="color:#3071a9;font-size:150%;">
		<input type="text" placeholder="enter" id="task" name="name<%=i %>" value="<%=rs3.getString(3) %>" readonly/>
                                                            ...
                                                            <span style="float:right;cursor:pointer;"
                                                                  onclick="sub('<%=rs3.getString(1) %>','<%= (Integer.parseInt(rs3.getString(2))+1) %>','<%=rs4.getString(1) %>','<%=rs3.getString(10) %>')">
	</span>
                                                        </b>
                                                    </td>

                                                    <td><input type="text" class="in" placeholder="enter"
                                                               name="mem_ass<%=i %>" value="<%=rs3.getString(4) %>"/>
                                                    </td>
                                                    <td id="basicExample"><input type="text" class="in date start"
                                                                                 id="pln_srt_date<%=i %>"
                                                                                 name="pln_srt_date<%=i %>"
                                                                                 value="<%=rs3.getString(7) %>"
                                                                                 onChange="pass('<%=rs3.getString(3)%>',this.value,'<%=i %>')"
                                                                                 readonly/></td>
                                                    <td id="basicExample"><input type="text" class="in date start"
                                                                                 id="pln_end_date<%=i %>"
                                                                                 name="pln_end_date<%=i %>"
                                                    ...
                                                    <td><input type="text" style="width:50px" ; id="status<%=i %>"/>
                                                    </td>
                                                    <td></td>
                                                    <td><i class="fa fa-plus"></i> <i class="fa fa-edit"></i> <i
                                                            class="fa fa-trash"></i></td>
                                                    <td style="display:none"><input type="text" name="seqnum<%=i %>"
		...
		<span style="color:#00BFFF;font-size:100%;">
			<input type="text" placeholder="enter" id="name<%=i %>" style="padding-left:15px; width:230px;"
                   name="name<%=i %>" value="<%=rs3.getString(3) %>" readonly/>
		</span>
                                                        <span style="float:right;cursor:pointer;"
                                                              onclick="sub('<%=rs3.getString(1) %>','<%= (Integer.parseInt(rs3.getString(2))+1) %>','<%=rs4.getString(1) %>','<%=rs3.getString(10) %>')">
		</span>
