(function () {
    ...
    f.AmRectangularChart = f.Class({
        inherits: f.AmCoordinateChart, construct: function (a) {
            ...
            if (!a.ignoreAxisWidth) {
                var h = a.labelsSet, e = a.tickLength;
                a.inside && (e = 0);
            ...
            if (!a.zbSet) {
                ...
                var c = a.color, d = a.fontSize, g = a.zoomOutButtonImageSize,
                    h = a.zoomOutButtonImage.replace(/\.[a-z]*$/i, ""), e = a.langObj.zoomOutText || a.zoomOutText,
            ...
            var a = this.dx, b = this.dy, c = this.marginLeftReal, d = this.marginTopReal, g = this.plotAreaWidth - 1,
                h = this.plotAreaHeight - 1, e = this.plotAreaFillColors,
                l = this.plotAreaFillAlphas, k = this.plotAreaBorderColor, m = this.plotAreaBorderAlpha;
            ...
            e.translate(c + a, d + b);
            this.set.push(e);
            0 !== a && 0 !== b && (e = this.plotAreaFillColors, "object" == typeof e && (e = e[0]), e = f.adjustLuminosity(e, -.15), g = f.polygon(this.container, [0, a, g + a, g, 0], [0, b, b, 0, 0], e, l, 1, k, m), f.setCN(this, g, "plot-area-bottom"), g.translate(c, d + h), this.set.push(g), a = f.polygon(this.container,
                [0, 0, a, a, 0], [0, h, h + b, b, 0], e, l, 1, k, m), f.setCN(this, a, "plot-area-left"), a.translate(c, d), this.set.push(a));
        ...
        updateObjectSize: function (a) {
            ...
            if (a) {
                a.rotate = b;
                var c = this.marginTopReal, d = this.marginLeftReal, g = a.scrollbarHeight, h = this.dx, e = this.dy,
                    f = a.offset;
        ...
        handleMouseDown: function (a) {
            ...
            if (a && a.enabled) {
                var b = a.valueAxes[0],
                    c = b.relativeStart, d = b.relativeEnd;
        ...
        updateAfterValueZoom: function () {
            ...
            var d = 1 / this.maxZoomFactor, g = f.getDecimals(d) + 4;
            ...
            if (this.skipZoomed) this.skipZoomed =
                !1; else {
                var b = this.startX0, c = this.endX0, d = this.endY0, g = this.startY0, h = a.startX, e = a.endX,
                    f = a.startY, k = a.endY;
...
(function () {
    ...
    f.AmSerialChart = f.Class({
        inherits: f.AmRectangularChart, construct: function (a) {
            this.type = "serial";
        ...
        initChart: function () {
            ...
            if (this.synchronizeGrid) {
                ...
                if (0 < a.length) {
                    ...
                    for (c = 0; c < a.length; c++) if (b = a[c], b.gridCountReal < d) {
                        var h = (d - b.gridCountReal) / 2, e = g = h;
            ...
            if (!this.wheelBusy) {
                var c = this.categoryAxis, d = c.parseDates, g = c.minDuration(), h = 1, e = 1;
                this.mouseWheelZoomEnabled ? b || (h = -1) : b && (h = -1);
                var f = this.chartCursor;
                if (f) {
                    var k = f.mouseX, f = f.mouseY;
            ...
            if (f.ifArray(d) && (a != this.startTime || b != this.endTime)) {
                var h =
                    g.minDuration(), e = this.firstTime, l = this.lastTime;
                a || (a = e, isNaN(c) || (a = l - c));
                b || (b = l);
                a > l && (a = l);
                b < e && (b = e);
            ...
            var a = this.trendLines, b;
            for (b = 0; b < a.length; b++) {
                var c = a[b], c = f.processObject(c, f.TrendLine, this.theme);
                a[b] = c;
                c.chart = this;
            ...
            var a = 0, b = this.valueAxes.length, c = this.graphs.length, d, g, f = !1, e, l;
            for (l = 0; l < b; l++) {
                g = this.valueAxes[l];
                var k = g.stackType, m = 0;
                if ("100%" == k || "regular" == k) for (f = !1, e = 0; e < c; e++) d = this.graphs[e], d.tcc = 1, d.valueAxis == g && "column" == d.type && (!f && d.stackable &&
            ...
            if (this.drawGraphs && (this.prevStartTime != this.startTime || this.prevEndTime != this.endTime)) {
                ...
                var b = this.categoryAxis, c = f.extractPeriod(b.minPeriod).period, b = b.dateFormatsObject[c];
            ...
            var e = g + Math.round((f - g) / 2), l = a[e][b];
                ...
                if (void 0 !== a) {
                    if (-1 != a.indexOf("[[category]]")) {
                        ...
                        if (this.categoryAxis.parseDates) {
                            var h = this.balloonDateFormat, e = this.chartCursor;
                            e && e.categoryBalloonDateFormat && (h = e.categoryBalloonDateFormat);
                            h = f.formatDate(g, h, this);
                            -1 != h.indexOf("fff") && (h = f.formatMilliseconds(h,
                                g));
                            g = h
                        }
                    ...
                    -1 != a.indexOf("[[") && b.graph.customData && (a = f.formatDataContextValue(a, b.graph.customData));
            ...
            if (a) {
                ...
                var h = a.valueZoomable, e = a.zoomable, l = a.valueLineEnabled;
                this.rotate ? (a.vLineEnabled = l, a.hZoomEnabled = h, a.vZoomEnabled = e) : (a.hLineEnabled = l, a.vZoomEnabled = h, a.hZoomEnabled = e);
                if (a.valueLineBalloonEnabled) for (l = 0; l < this.valueAxes.length; l++) h = this.valueAxes[l], (e = h.balloon) || (e = {}), e = f.extend(e, this.balloon, !0), e.fillColor = d, e.balloonColor = d, e.fillAlpha = c, e.borderColor =
                    d, e.color = g, h.balloon = e; else for (e = 0; e < this.valueAxes.length; e++) h = this.valueAxes[e], h.balloon && (h.balloon = null);
        ...
        zoomOut: function () {
                ...
                if (d) {
                    ...
                    if (g = this.chartData[g]) {
                        ...
                        if (b.oneBalloonOnly && b.valueBalloonsEnabled) {
                            var m = Infinity;
                            for (h = d.length - 1; 0 <= h; h--) if (e = d[h], e.balloon.enabled && e.showBalloon && !e.hidden) {
                                l = e.valueAxis.id;
            ...
            var b = a.target, c, d = a.deltaX,
                g = a.deltaY, h = a.delta2X, e = a.delta2Y;
            a = !1;
            if (this.rotate) {
                isNaN(h) && (h = d, a = !0);
                var l = this.endX0;
            ...
            a = !1;
            isNaN(h) && (h = d, a = !0);
            if (b.zoomable && (0 < Math.abs(d) || 0 < Math.abs(h))) if (c.parseDates &&
                !c.equalSpacing) {
...
(function () {
    ...
    f.Cuboid = f.Class({
        construct: function (a, b, c, d, f, h, e, l, k, m, p, n, u, v, x, E, t) {
            ...
            var a = this.set;
            a.clear();
            var b = this.container, c = b.chart, d = this.w, g = this.h, h = this.dx, e = this.dy, l = this.colors,
            ...
            if (0 < Math.abs(h) || 0 < Math.abs(e)) if (isNaN(t)) z = q, q = f.adjustLuminosity(B, -.2), q = f.adjustLuminosity(B, -.2), w = f.polygon(b, [0, h, d + h, d, 0], [0, e, e, 0, 0],
                q, k, 1, p, 0, u), 0 < n && (M = f.line(b, [0, h, d + h], [0, e, e], p, n, m, x)), y = f.polygon(b, [0, 0, d, d, 0], [0, g, g, 0, 0], q, k, 1, p, 0, u), y.translate(h, e), 0 < n && (C = f.line(b, [h, h], [e, e + g], p, n, m, x)), F = f.polygon(b, [0, 0, h, h, 0], [0, g, g + e, e, 0], q, k, 1, p, 0, u), D = f.polygon(b, [d, d, d + h, d + h, d], [0, g, g + e, e, 0], q, k, 1, p, 0, u), 0 < n && (A = f.line(b, [d, d + h, d + h, d], [0, e, g + e, g], p, n, m, x)), q = f.adjustLuminosity(z, .2), z = f.polygon(b, [0, h, d + h, d, 0], [g, g + e, g + e, g, g], q, k, 1, p, 0, u), 0 < n && (L = f.line(b, [0, h, d + h], [g, g + e, g + e], p, n, m, x)); else {
                var N, O, P;
            ...
            d = isNaN(t) ? 0 > g ? [w,
                M, y, C, F, D, A, z, L, b] : [z, L, y, C, F, D, w, M, A, b] : K ? 0 < d ? [w, b, z] : [z, b, w] : 0 > g ? [w, b, z] : [z, b, w];
            f.setCN(c, b, r + "front");
            f.setCN(c, y, r + "back");
            f.setCN(c, z, r + "top");
...
(function () {
    ...
    f.CategoryAxis = f.Class({
        inherits: f.AxisBase, construct: function (a) {
            ...
            if (f.ifArray(a)) {
                ...
                var d = this.start, g = this.labelFrequency, h = 0, e = this.end - d + 1, l = this.gridCountR,
                    k = this.showFirstLabel, m = this.showLastLabel, p, n = "", n = f.extractPeriod(this.minPeriod),
                    u = f.getPeriodDuration(n.period, n.count), v, x, E, t, r, B = this.rotate, q = this.firstDayOfWeek,
                ...
                if (this.parseDates && !this.equalSpacing) this.lastTime = a[a.length - 1].time, this.maxTime = f.resetDateToMin(new Date(this.lastTime + 1.05 * u), this.minPeriod,
                    ...
                    r && 1 < v && (t = this.chooseMinorFrequency(v), f.getPeriodDuration(g,
                        t));
                    if (0 < this.gridCountR) for (b = e; b < C; b++) if (t = this.data[b].time, this.checkPeriodChange(g, v, t, n) && b >= F) {
                ...
                for (b = k = 0; b < this.data.length; b++) if (t = this.data[b]) this.parseDates && !this.equalSpacing ? (m = t.time, d = this.cellWidth, "MM" == this.minPeriod && (d = 864E5 * f.daysInMonth(new Date(m)) * this.stepWidth, t.cellWidth =
                ...
                for (b = 0; b < y; b++) if (k = this.guides[b], q = q = q = r = d = NaN, m = k.above, k.toCategory && (q = c.getCategoryIndexByValue(k.toCategory), isNaN(q) || (d = this.getCoordinate(q - h), k.expand &&
                ...
                (p = !1), p = "H" == this.orientation ? new this.axisItemRenderer(this, r, k.label, p, 2 * q, NaN, k) : new this.axisItemRenderer(this, r, k.label, !1, NaN, q, k), this.pushAxisItem(p, m)), p && (q = p.label) && this.addEventListeners(q, k), 0 < d || 0 < r) {
                    q = !1;
                    if (this.rotate) {
                ...
                if (c = c.chartCursor) B ? c.fixHeight(this.cellWidth) : (c.fixWidth(this.cellWidth),
            ...
            if (this.parseDates && !this.equalSpacing) a =
                this.startTime + Math.round(a / g) - this.minDuration() / 2, h = c.getClosestIndex(b, "time", a, !1, this.start, this.end + 1); else if (this.widthField) for (c = Infinity, g = this.start; g <= this.end; g++) {
                var e = this.data[g];
            ...
            var d = "", g = "", h = this.chart, e = this.data[b];
            if (e) if (this.parseDates) d = f.formatDate(e.category, c, h), b = f.changeDate(new Date(e.category), this.minPeriod, 1), g = f.formatDate(b, c, h), -1 != d.indexOf("fff") && (d = f.formatMilliseconds(d, e.category), g = f.formatMilliseconds(g, b)); else {
                var l;
