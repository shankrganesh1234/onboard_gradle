        ...
        var c, d = {
            ...
            drawing: {
                ...
                handler: {
                    undo: function (a, b) {
                        ...
                        var b = d.deepMerge({top: d.setup.fabric.height / 2, left: d.setup.fabric.width / 2}, a || {}),
                        ...
                        var f, g, h, e = d.deepMerge({}, a || {}), i = c || d.drawing.buffer.target,
            ...
            capture: function (a, b) {
                ...
                for (d.setup.canvas = document.createElement("canvas"), d.setup.wrapper.appendChild(d.setup.canvas), d.setup.fabric = new fabric.Canvas(d.setup.canvas, d.deepMerge({
                    ...
                    var b = a.target, c = JSON.parse(b.recentState),
                        e = d.deepMerge(b.saveState().originalState, {cfg: c.cfg});
                    ...
                    "stock" == d.setup.chart.type && d.setup.chart.legendSettings.position ? ["top", "bottom"].indexOf(d.setup.chart.legendSettings.position) != -1 ? k.parent.style.top && k.parent.style.left ? (k.offset.y = d.pxToNumber(k.parent.style.top), k.offset.x = d.pxToNumber(k.parent.style.left)) : (k.offset.x = g.x, k.offset.y = g.y, g.y += d.pxToNumber(k.parent.style.height), k.has.panel ? (g.pY = d.pxToNumber(k.has.panel.style.marginTop), k.offset.y += g.pY) : k.has.scrollbar && (k.offset.y += g.pY)) : ["left", "right"].indexOf(d.setup.chart.legendSettings.position) != -1 && (k.offset.y = d.pxToNumber(k.parent.style.top) + g.pY, k.offset.x = d.pxToNumber(k.parent.style.left) + g.pX, k.has.legend ? g.pY += d.pxToNumber(k.has.panel.style.height) + d.setup.chart.panelsSettings.panelSpacing : k.has.scrollbar && (k.offset.y -= d.setup.chart.panelsSettings.panelSpacing)) : ("absolute" == k.parent.style.position ? (k.offset.absolute = !0, k.offset.top = d.pxToNumber(k.parent.style.top), k.offset.right = d.pxToNumber(k.parent.style.right, !0), k.offset.bottom = d.pxToNumber(k.parent.style.bottom, !0), k.offset.left = d.pxToNumber(k.parent.style.left), k.offset.width = d.pxToNumber(k.parent.style.width), k.offset.height = d.pxToNumber(k.parent.style.height)) : k.parent.style.top && k.parent.style.left ? (k.offset.y = d.pxToNumber(k.parent.style.top), k.offset.x = d.pxToNumber(k.parent.style.left)) : k.legend ? ("left" == k.legend.position ? g.x = i.maxWidth : "right" == k.legend.position ? k.offset.x = g.width - i.maxWidth : "top" == k.legend.position ? g.y += k.legend.height : "bottom" == k.legend.position && (k.offset.y = g.height - i.height), k.offset.y += g.lY, g.lY += k.legend.height) : (k.offset.x = g.x, k.offset.y = g.y + g.pY, g.y += d.pxToNumber(k.parent.style.height)), k.has.legend && k.has.panel && k.has.panel.style.marginTop ? (g.y += d.pxToNumber(k.has.panel.style.marginTop), k.offset.y += d.pxToNumber(k.has.panel.style.marginTop)) : d.setup.chart.legend && ["left", "right"].indexOf(d.setup.chart.legend.position) != -1 && (k.offset.y = d.pxToNumber(k.parent.style.top), k.offset.x = d.pxToNumber(k.parent.style.left))), fabric.parseSVGDocument(k.svg, function (a) {
                        return function (c, i) {
                            var j, l = fabric.util.groupSVGElements(c, i), m = [],
                                n = {selectable: !1, isCoreElement: !0};
                            for (a.offset.absolute ? (void 0 !== a.offset.bottom ? n.top = g.height - a.offset.height - a.offset.bottom : n.top = a.offset.top, void 0 !== a.offset.right ? n.left = g.width - a.offset.width - a.offset.right : n.left = a.offset.left) : (n.top = a.offset.y, n.left = a.offset.x), j = 0; j < l.paths.length; j++) {
                                ...
                                if (l.paths[j]) {
                                    ...
                                    (o = d.isHashbanged(l.paths[j].clipPath)) && a.clippings && a.clippings[o] && (!function (b, c) {
                                        ...
                                        clipTo: function (b, c) {
                                            return function (e) {
                                                var f = a.clippings[c], g = this.transformMatrix || [1, 0, 0, 1, 0, 0],
                                                    h = {
                                                        top: f.bbox.y,
                                                        left: f.bbox.x,
                                                        width: f.bbox.width,
                            ...
                            if (l.paths = m, n.top += .5, n.left += .5, l.set(n), d.setup.fabric.add(l), a.svg.parentNode && a.svg.parentNode.getElementsByTagName) {
                                ...
                                for (j = 0; j < q.length; j++) if (e.balloonFunction instanceof Function) e.balloonFunction.apply(d, [q[j], a]); else {
                                    var r = q[j], s = fabric.parseStyleAttribute(r),
                            ...
                            if (a.svg.nextSibling && "A" == a.svg.nextSibling.tagName) {
                                var r = a.svg.nextSibling, s = fabric.parseStyleAttribute(r),
                                    u = new fabric.Text(r.innerText || r.textContent || r.innerHTML, {
                                        selectable: !1,
                                        top: s.top + a.offset.y,
                                        left: s.left + a.offset.x,
                        ...
                        var c, f = d.gatherAttribute(a, "class"), g = d.gatherAttribute(a, "visibility"),
                            h = d.gatherAttribute(a, "clip-path");
                        b.className = String(f), b.classList = String(f).split(" "), b.clipPath = h, b.svg = a;
                        var i = ["fill", "stroke"];
                        for (c = 0; c < i.length; c++) {
                            var j = i[c], k = String(a.getAttribute(j) || "none"),
                                l = Number(a.getAttribute(j + "-opacity") || "1"), m = d.getRGBA(k);
            ...
            toImage: function (a, b) {
                var c = d.deepMerge({format: "png", quality: 1, multiplier: d.config.multiplier}, a || {}), e = c.data,
            ...
            toBlob: function (a, b) {
                var e, c = d.deepMerge({data: "empty", type: "text/plain"}, a || {}),
            ...
            toSVG: function (a, b) {
                var g, c = [], e = [], f = d.deepMerge({
                    compress: d.config.compress, reviver: function (a, b) {
                        var f = new RegExp(/\bstyle=(['"])(.*?)\1/), g = f.exec(a)[0].slice(7, -1), h = g.split(";"),
                            i = [];
                        ...
                        if (a = a.replace(g, i.join(";")), b && b.svg) {
                            var o = b.svg.id, p = 2, q = a.slice(-p);
                            "/>" != q && (p = 3, q = a.slice(-p));
                            var s = (a.slice(0, a.length - p), ' clip-path="url(#' + b.svg.id + ')" ');
                            if (a = "<g " + s + ">" + a + "</g>", e.indexOf(o) == -1) {
                                var t = (new XMLSerializer).serializeToString(b.svg);
            ...
            toPRINT: function (a, b) {
                var c, e = d.deepMerge({delay: .01, lossless: !1}, a || {}), f = d.toImage(e), g = [],
                    h = document.body.childNodes, i = document.documentElement.scrollTop || document.body.scrollTop;
                ...
                return document.body.appendChild(f), setTimeout(function () {
                    window.print(), e.delay *= 1e3;
                    var a = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream;
                    a && e.delay < 1e3 && (e.delay = 1e3), setTimeout(function () {
            ...
            toCSV: function (a, b) {
                var c, f = d.deepMerge({delimiter: ",", quotes: !0, escape: !0, withHeader: !0}, a || {}, !0), g = [],
                    h = "";
                g = d.toArray(f);
            ...
            toArray: function (a, b) {
                ...
                var c, e, f = d.deepMerge({withHeader: !1, stringify: !0, escape: !1, quotes: !1}, a || {}, !0), g = [],
                    h = [], i = [], j = d.config.processData;
            ...
            toByteArray: function (a, b) {
                ...
                var c = d.deepMerge({}, a || {}), e = "undefined" != typeof Uint8Array ? Uint8Array : Array,
                    f = "+".charCodeAt(0), g = "/".charCodeAt(0), h = "0".charCodeAt(0), i = "a".charCodeAt(0),
                    j = "A".charCodeAt(0), k = m(c.data);
                ...
                if (c.data.length) {
                    ...
                    for (e = 0; e < c.data.length; e++) {
                        ...
                        for (f = 0; f < c.dataFields.length; f++) {
                            var j = c.dataFields[f], k = c.dataFieldsMap[j],
                                l = c.columnNames && c.columnNames[j] || c.titles[j] || j, m = c.data[e][k];
            ...
            createMenu: function (b, c) {
                function g(b, c) {
                    ...
                    for (e = 0; e < b.length; e++) {
                        var j = "string" == typeof b[e] ? {format: b[e]} : b[e], k = document.createElement("li"),
                            l = document.createElement("a"), m = document.createElement("img"),
                        ...
                        if (j.format = String(j.format).toUpperCase(), l.addEventListener("focus", function (a) {
                            d.setup.hasTouch || (d.setup.focusedMenuItem = this, this.parentNode.classList.add("active"), this.parentNode.parentNode.parentNode.classList.add("active"))
            ...
            delay: function (a, b) {
                var e, f, c = d.deepMerge({delay: 3, precision: 2}, a || {}), g = Number(new Date), h = d.createMenu([{
            ...
            loadListeners: function () {
                ...
                d.config.keyListener && "attached" != d.config.keyListener && (d.docListener = function (b) {
                    ...
                    function m() {
                        function a(b) {
                            d.isElement(b) && (b.blur(), b.parentNode && b.parentNode.classList.remove("active"), b.classList.contains("amExportButton") || a(b.parentNode))
                        }

                        d.setup.focusedMenuItem && (a(d.setup.focusedMenuItem), d.setup.focusedMenuItem = void 0)
                    }

                    var c = d.drawing.buffer.target, e = [37, 38, 39, 40, 13, 9, 27],
                        g = (["top-left", "bottom-left"].indexOf(d.config.position) != -1, ["top-right", "bottom-right"].indexOf(d.config.position) != -1);
