AmCharts.translations.dataLoader = {}, AmCharts.addInitHandler(function (a) {
    function e(b, d, g, h) {
        void 0 === h && (h = "dataProvider"), g.showCurtain && l(void 0, g.noStyles), c.remaining++, c.percentLoaded[b] = 0, void 0 !== g.progress && "function" == typeof g.progress && void 0 === g._progress && (g._progress = g.progress, g.progress = function (a) {
            ...
            if (!1 === i) n(g.error, g, a), k(AmCharts.__("Error loading the file", a.language) + ": " + b, !1, g); else {
                ...
                if (c.remaining--, 0 === c.remaining && (n(g.complete, a), g.async)) if ("map" === a.type) a.validateNow(!0), m(); else if ("gauge" !== a.type && a.addListener("dataUpdated", function (b) {
                    "stock" !== a.type || g.reloading || void 0 === a.periodSelector || a.periodSelector.setDefaultPeriod(), m(), a.events.dataUpdated.pop()
                }), a.validateData(), "gauge" === a.type && m(), c.startDuration) if ("stock" === a.type) {
                ...
                g.reload && (g.timeout && clearTimeout(g.timeout), g.timeout = setTimeout(e, 1e3 * g.reload, b, d, g, h), g.reloading = !0)
            }
        })
    }
    ...
    if (void 0 !== b.headers && b.headers.length) for (var f = 0; f < b.headers.length; f++) {
        var g = b.headers[f];
    ...
    var g, h, c = AmCharts.CSVToArray(a, b.delimiter), d = b.numberFields && b.numberFields.length > 0, e = [], f = [];
    if (b.useColumnNames) {
        f = c.shift();
    ...
    for (var j; j = b.reverse ? c.pop() : c.shift();) if (!b.skipEmpty || 1 !== j.length || "" !== j[0]) {
        var k = {};
