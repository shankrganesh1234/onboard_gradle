...
<div class="container">
    ...
    <form method="post" action="update_pass" role="login" name="loginForm">
        <div class="row">
            <div class="col-sm-5 form-group"><label>New Password </label><input type="password" name="new_pass" required
                                                                                class="form-control input-lg"/></div>
        </div>
        <div class="row">
            <div class="col-sm-5 form-group"><label>Confirm Password </label><input type="password" name="new_cpass"
                                                                                    required
