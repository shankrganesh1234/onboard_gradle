                                                    ...
                                                    <div class="content table-responsive table-full-width">
                                                        <table class="table table-hover table-striped">
                                                            ...
                                                            <tr style="background-color:white;">
                                                                <td><input type="checkbox" name="delete_check"
                                                                           id="delete_check"></td>
                                                                <td><%= rs.getString(1) %>
                                                                </td>
                                                                <td><%= rs.getString(2) %>
                                                                ...
                                                                <td style="background-color:lightgreen"><%=rs.getString(8) %>
                                                                </td>
                                                                <td style="text-align:center;"><input type="checkbox"
                                                                                                      name="chek"
                                                                                                      onChange="selectCheck('<%=rs.getString(1) %>');">
                                                                </td>
                                                                <td style="display:none;"><input type="text"
                                                                                                 name="name_user<%=count%>"
                                                            ...
                                                            <tr style="background-color:#ccc;cursor:not-allowed;">
                                                                ...
                                                                <td style="text-align:center;background-color:white;">
                                                                    <input type="checkbox" name="chek" id="chek"
                                                                           onChange="selectCheckDeac('<%=rs.getString(1) %>')"
                                                                           checked></td>
                                                                <td style="display:none;"><input type="text"
                                                                                                 name="name_user<%=count%>"
                                                                                                 value="<%= rs.getString(1) %>">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="button" id="del_btn" class="btn btn-primary"
                                                                   onclick="del(<%=count %>);deluser();"
                                                                   value="DeleteUser">
                                                            &nbsp;&nbsp;
                                                            <button type="button" id="sub_btn" class="btn btn-primary"
                                                                    onclick="servlet_call();">Submit
                                                            </button>
