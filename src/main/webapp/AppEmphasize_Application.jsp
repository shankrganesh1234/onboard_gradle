        ...
        <nav class="navbar top-navbar bg-white box-shadow">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- /.navbar-header -->
                    <a class="navbar-brand" href="Project_List" id="sitetitle">Onboarding Tool-<%= Project_name %>
                    </a>
                                ...
                                <div class="panel-group" id="panels1">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title"><a data-toggle="collapse" data-parent="#panels1"
                                                                       href="#collapse2"> Application Information </a>
                                            </h4>
                                        </div>
                                        ...
                                        <div id="collapse2" class="panel-collapse">
                                            <div class="panel-body text-left">
                                                ...
                                                <div class="table-responsive" id="table-scroll">
                                                    ...
                                                    <table class="js-dynamitable     table table-bordered" id="myTable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="edit_row"
                                                                style="cursor:pointer"><%=rs1.getString("appname") %>
                                                            </td>
                                                ...
                                                <input type="text" class="form-control" id="app_name"
                                                       placeholder="Application Name" name="appname">
                                                <input type="hidden" class="form-control" id="formInput198"
                                                       placeholder="Application Name" name="prjname"
                                                       value="<%=rs3.getString("projectname") %>">
                                                </br>
                                                <input type="submit" id="bttn" class="btn btn-primary btn pull-left"
                                                       name="p1" value="Add">


                                                <input type="text" id="role_info" value="<%= Role_info %>"
                                                       style="display:none">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <button type="button" class="btn btn-default"
                                            onclick="location.href='AppEmphasize_EditProject.jsp';">Back
                                    </button>
                                    <button type="button" class="btn btn-success pull-right"
                                            onclick="location.href='AppEmphasize_CostCalculation.jsp';">Save &
                                        Continue...
                                    </button>
